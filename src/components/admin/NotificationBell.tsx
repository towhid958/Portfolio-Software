...
// The hand-written version of this declared is_read and created_at as
// non-nullable while the table allows null in both, which is exactly what the
// `as any[]` below was hiding.
  ...
  useEffect(() => {
    ...
    const channel = supabase
      ...
      .on(
        ...
        (payload: RealtimePostgresInsertPayload<AdminNotification>) => {
